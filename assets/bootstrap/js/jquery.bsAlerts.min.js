...
!(function (t, e, n, r) {
  ...
  var s = function (e, r) {
      ...
      var a,
        o = this
      ;(o.element = e),
        (o.options = t.extend({}, t.fn.bsAlerts.defaults, r)),
        t(n).on('add-alerts', function () {
      ...
      t.each(Object.keys(l), function (t, e) {
        ...
        (o.addAlerts = function (t) {
          var e = i([].concat(t))
          o.addAlertsToContainer(e.errs),
            o.addAlertsToContainer(e.warns),
            o.addAlertsToContainer(e.infos),
            o.addAlertsToContainer(e.succs)
        ...
        (o.addAlertsToContainer = function (e) {
          if (e.length > 0) {
            ...
            if (i.length > 0) {
              var a = (o.options.usebullets = i.find('p'))
              o.attachLIs(a, e)
        ...
        (o.attachLIs = function (e, n) {
          t.each(n, function (n, r) {
            o.options.usebullets
              ? e.append(t('<p/>').html(r.message))
              : e.append(
                  n > 0 || e[0].childNodes.length
                    ? '<br /><br />' + r.message
                    : r.message,
                )
          })
  ...
  ;(t.fn.bsAlerts = function (e) {
    return this.each(function () {
      var n = t(this),
        r = n.data('bsAlerts'),
        i = 'object' == typeof e && e
      r || n.data('bsAlerts', (r = new s(this, i))),
        'string' == typeof e && r[e]()
    })
  }),
    (t.fn.bsAlerts.Constructor = s),
    (t.fn.bsAlerts.defaults = {
      titles: {},
      ids: '',
      fade: '0',
      usebullets: !0,
